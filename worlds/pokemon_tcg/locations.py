...
location_data = [ # TODO add trades/promoes
    ...
    LocationData("Psychic Club Main Hall", "Beat Nikki", "Beat Nikki", event=True),
    ...
    LocationData("Psychic Club Lounge", "Beat Nikki", "Beat Nikki", event=True),
    ...
    LocationData("Rock Club Main Hall", "Beat Nikki", "Beat Nikki", event=True),
