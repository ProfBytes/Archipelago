...
location_data = [ # TODO add trades/promoes
    ...
    LocationData("Fire Club Lounge", "Beat Nikki", "Beat Nikki", event=True),
    # Add event for Jessica 1
    ...
    LocationData("Grass Club Lobby", "Beat Nikki", "Beat Nikki", event=True),
    # Add event for Michael 1
    ...
    LocationData("Rock Club Lounge", "Beat Nikki", "Beat Nikki", event=True),
    # Add event for Chris 1
    ...
    LocationData("Fighting Club Main Hall", "Beat Nikki", "Beat Nikki", event=True),
    ...
    LocationData("Rock Club Lounge", "Ronald Reward 1", "Evolution Pack", rom_addresses["Ronald_Reward_1"]), # 2 Medals
    LocationData("Fire Club Lounge", "Ronald Reward 2", "Laboratory Pack", rom_addresses["Ronald_Reward_2"]), # 2 Medals
    LocationData("Grass Club Lounge", "Ronald Rematch Reward 1", "Colosseum Pack", rom_addresses["Ronald_Rematch_Reward_1"]), # 5 Medals
    LocationData("Psychic Club Lounge", "Ronald Rematch Reward 2", "Mystery Pack", rom_addresses["Ronald_Rematch_Reward_2"]), # 5 Medals
    ...
    # Promo cards
    LocationData("Water Club Lounge", "Promo Arcanine Trade", "Promo Arcanine", rom_addresses["Promo_Arcanine"]),
    LocationData("Grass Club Lounge", "Promo Pikachu Trade (Grass Club)", "Promo Pikachu 1", rom_addresses["Promo_Pikachu_1"]),
    LocationData("Fighting Club Lounge", "Promo Pikachu Trade (Fighting Club)", "Promo Pikachu 2", rom_addresses["Promo_Pikachu_2"]),
    LocationData("Ishihara's House", "Ishihara Trade 1", "Promo Flying Pikachu", rom_addresses["Promo_Flying_Pikachu"]),
    LocationData("Ishihara's House", "Ishihara Trade 2", "Promo Surfing Pikachu 1", rom_addresses["Promo_Surfing_Pikachu_1"]),
    LocationData("Ishihara's House", "Ishihara Trade 3", "Promo Surfing Pikachu 2", rom_addresses["Promo_Surfing_Pikachu_2"]),
    LocationData("Lightning Club Lounge", "Promo Electabuzz Trade", "Promo Electabuzz", rom_addresses["Promo_Electabuzz"]),
    LocationData("Fire Club Lounge", "Promo Slowpoke Trade", "Promo Slowpoke", rom_addresses["Promo_Slowpoke"]),
    LocationData("Psychic Club Lounge", "Promo Mewtwo Gift", "Promo Mewtwo 2", rom_addresses["Promo_Mewtwo_2"]),

    # Email logic
    LocationData("Mason Laboratory Center Room", "Email 1", "Energy Pack", rom_addresses["Email_1"]),
    LocationData("Mason Laboratory Center Room", "Email 2", "Energy Pack", rom_addresses["Email_2"]),
    LocationData("Mason Laboratory Center Room", "Email 3", "Energy Pack", rom_addresses["Email_3"]),
    LocationData("Mason Laboratory Center Room", "Email 4", "Energy Pack", rom_addresses["Email_4"]),
    LocationData("Mason Laboratory Center Room", "Email 5", "Energy Pack", rom_addresses["Email_5"]),
    LocationData("Mason Laboratory Center Room", "Email 6", "Energy Pack", rom_addresses["Email_6"]),
    LocationData("Mason Laboratory Center Room", "Email 7", "Energy Pack", rom_addresses["Email_7"]),
    LocationData("Mason Laboratory Center Room", "Email 8", "Energy Pack", rom_addresses["Email_8"]),
    LocationData("Mason Laboratory Center Room", "Email 9", "Energy Pack", rom_addresses["Email_9"]),
    LocationData("Mason Laboratory Center Room", "Email 10", "Energy Pack", rom_addresses["Email_10"]),
    LocationData("Mason Laboratory Center Room", "Email 11", "Energy Pack", rom_addresses["Email_11"]),
    LocationData("Mason Laboratory Center Room", "Email 12", "Energy Pack", rom_addresses["Email_12"]),
    LocationData("Mason Laboratory Center Room", "Email 13", "Energy Pack", rom_addresses["Email_13"]),
    LocationData("Mason Laboratory Center Room", "Email 14", "Energy Pack", rom_addresses["Email_14"]),
    LocationData("Mason Laboratory Center Room", "Email 15", "Energy Pack", rom_addresses["Email_15"]),
