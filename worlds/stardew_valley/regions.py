...
vanilla_regions = [
    ...
    RegionData(SVRegion.witch_swamp, [SVEntrance.enter_witch_hut]),
    RegionData(SVRegion.witch_hut),
    ...
    RegionData(SVRegion.volcano, [SVEntrance.climb_to_volcano_5, SVEntrance.volcano_to_secret_beach]),
    RegionData(SVRegion.volcano_secret_beach),
